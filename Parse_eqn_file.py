...
def write_partitioning_section_fortran():
    ...
    #f.write('import numpy as np\n') 
    f.write('\n')
    f.write('subroutine dydt_partition(total_length_y,num_bins,num_species,& \n')
    f.write('                          y,ycore,core_diss,core_mass_array,& \n') 
    ...
    f.write('    INTEGER, intent(in) :: total_length_y,num_bins,num_species \n')
    f.write('    !f2py intent(in) ::  total_length_y,num_bins,num_species \n')
    f.write('    REAL(8), intent(in), dimension(total_length_y) :: y \n')
    f.write('    !f2py intent(in) :: y \n') 
    f.write('    REAL(8), intent(in), dimension(num_bins) :: ycore,core_mass_array,& \n')
    ...
    f.write('    REAL(8), intent(in), dimension(num_species) :: density_input,DStar_org,& \n')
    ...
    f.write('    INTEGER(8), intent(in), dimension(num_species) :: ignore_index,mw_array,Psat \n')
    ...
    f.write('    REAL(8), intent(out), dimension(num_bins) :: aw_array \n')
    f.write('    REAL(8), intent(out), dimension(num_bins) :: size_array \n')
    f.write('    REAL(8), intent(out), dimension(total_length_y) :: dy_dt \n')
    ...
    f.write('    REAL(8), dimension(num_species) :: Inverse_Kn, Correction_part1, &\n') 
    f.write('                              Correction_part2, Correction_part3,& \n')
    f.write('                              Correction, Kn, dm_dt,& \n')
    f.write('                              k_i_m_t_part1, k_i_m_t \n') 
    f.write('    REAL(8), dimension(num_species,num_bins) :: dy_dt_gas_matrix \n')
    f.write('    REAL(8) total_moles, density, diameter, radius, water_moles  \n')
    f.write('    REAL(8), dimension(num_species) :: Pressure_eq, Cstar_i_m_t \n') 
    f.write('    REAL(8), dimension(num_species) :: kelvin_factor,y_mole_fractions  \n')
    f.write('    REAL(8), dimension(num_species) :: temp_array  \n')
    f.write('    REAL(8), dimension(num_species+1) :: mass_array, density_array, mass_fractions_array \n') 
    ...
    f.write('\n')     
    f.write('    PRINT *, total_length_y,num_bins,num_species')    
    f.write('\n')     
    f.write('!$OMP PARALLEL DO &\n') 
    ...
    f.write('    DO size_step=1,num_bins \n') 
    f.write('\n')     	
